...
implements SpeechletV2
{
	...
	static String continueMsg = "M√∂chten Sie weiterspielen?";
	static String congratsMsg = "Herzlichen Gl√ºckwunsch! Sie haben eine Million Punkte gewonnen.";
	...
	private void selectQuestionVokMittel() {
		...
		case 300: question = "gebrochen heiﬂt auf englisch broken. Sage gebrochen auf englisch."; correctAnswer = "broken"; break;
		case 500: question = "Kerze heiﬂt auf englisch candle.Sage Kerze auf englisch"; correctAnswer = "candle"; break;
		case 1000: question = "Vertrag heiﬂt auf englisch contract. Sage Vertrag auf englisch"; correctAnswer = "contract"; break;
		case 2000: question = "Gemeinschaft heiﬂt auf Englisch community. Sage Gemeinschaft auf englisch."; correctAnswer = "community"; break;
		case 4000: question = "Feld heiﬂt auf englisch field. Sage Feld auf englisch."; correctAnswer = "field"; break;
		case 8000: question = "Sturm heiﬂt auf englisch gale. Sage Sturm auf englisch."; correctAnswer = "gale"; break;
		case 16000: question = "aufgeben heiﬂt auf englisch give up. Sage aufgeben auf englisch"; correctAnswer = "give up"; break;
		case 32000: question = "Mikrowelle heiﬂt auf englisch microwave. Sage Mikrowelle auf englisch"; correctAnswer = "microwave"; break;
		case 64000: question = "Kopfkissen heiﬂt auf englisch pillow. Sage Kissen auf englisch."; correctAnswer = "pillow"; break;
		case 125000: question = "Politik heiﬂt auf englisch policy. Sage Politik auf englisch."; correctAnswer = "Policy"; break;
		case 500000: question = "Gleichgewicht heiﬂt auf englisch balance. Sage Gleichgewicht auf englisch."; correctAnswer = "Balance"; break;
		}
	}

	private void selectQuestionVokSchwer() {
		switch(sum){
		case 0: question = "Bekannter heiﬂt auf englisch acquaintance. Sage Bekannter auf englisch."; correctAnswer = "acquaintance"; break;
		case 50: question = "rechthaberisch heiﬂt auf englisch bossy. Sage rechthaberisch auf englisch."; correctAnswer = "bossy"; break;
		...
		case 200: question = "groﬂherzig bedeutet auf englisch generous. Sage groﬂherzig auf englisch."; correctAnswer = "generous"; break;
		...
		case 500: question = "Schwiegermutter heiﬂt auf englisch mother in law. Sage Schwiegermutter auf englisch."; correctAnswer = "mother in law"; break;
		case 1000: question = "launisch heiﬂt auf englisch moody. Sage launisch auf englisch."; correctAnswer = "moody"; break;
		case 2000: question = "vertrauensw¸rdig heiﬂt auf englisch reliable. Sage vetrauensw¸rdig auf englisch."; correctAnswer = "reliable"; break;
		case 4000: question = "Rechnungswesen heiﬂt auf englisch accountancy. Sage auf englisch Rechnungswesen."; correctAnswer = "accountancy"; break;
		case 8000: question = "sich bewerben heiﬂt auf englisch apply. Sage sich bewerben auf englisch."; correctAnswer = "apply"; break;
		case 16000: question = "flieﬂend heiﬂt auf englisch fluently. Sage flieﬂend auf englisch."; correctAnswer = "fluently"; break;
		case 32000: question = "auf entwas bestehen heiﬂt auf englisch insist. Sage auf entwas bestehen auf englisch"; correctAnswer = "insist"; break;
		case 64000: question = "Vertreter heiﬂt auf englisch representative. Sage Vertreter auf englisch."; correctAnswer = "representative"; break;
		case 125000: question = "reibungslos heiﬂt auf englisch smoothly. Sage reibungslos auf englisch."; correctAnswer = "smoothly"; break;
		case 500000: question = "bereit sein heiﬂt auf englisch be willing to. Sage bereit sein auf englisch"; correctAnswer = "be willing to"; break;
		}
	}
